...
-- Define a keymap to open the picker (e.g., <leader>fb for Fuzzy Buffer)
vim.keymap.set('n', '<leader>fb', '<cmd>FuzzyBufferPicker<CR>', { desc = 'Open Fuzzy Buffer Picker' })
...
keymap.set(
  ...
  { noremap = true, silent = true, desc = "Toggle Aerial left (focus)" }
)
